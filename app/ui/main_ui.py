...
"}")
        ...
        QWidget.setTabOrder(self.lineEdit_7, self.spinBox_3)
        QWidget.setTabOrder(self.spinBox_3, self.comboBox)
        QWidget.setTabOrder(self.comboBox, self.lineEdit_8)
        QWidget.setTabOrder(self.lineEdit_8, self.comboBox_2)
        QWidget.setTabOrder(self.comboBox_2, self.doubleSpinBox_2)
        QWidget.setTabOrder(self.doubleSpinBox_2, self.doubleSpinBox)
        QWidget.setTabOrder(self.doubleSpinBox, self.spinBox)
        QWidget.setTabOrder(self.spinBox, self.lineEdit_10)
        QWidget.setTabOrder(self.lineEdit_10, self.lineEdit_11)
        QWidget.setTabOrder(self.lineEdit_11, self.spinBox_2)
        QWidget.setTabOrder(self.spinBox_2, self.tableView_2)
        QWidget.setTabOrder(self.tableView_2, self.pushButton_8)
        QWidget.setTabOrder(self.pushButton_8, self.pushButton_4)
        QWidget.setTabOrder(self.pushButton_4, self.tableView)
        QWidget.setTabOrder(self.tableView, self.pushButton_9)
        QWidget.setTabOrder(self.pushButton_9, self.pushButton_6)
        QWidget.setTabOrder(self.pushButton_6, self.pushButton_15)
        QWidget.setTabOrder(self.pushButton_15, self.pushButton_14)
        QWidget.setTabOrder(self.pushButton_14, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.pushButton_13)
        QWidget.setTabOrder(self.pushButton_13, self.pushButton_16)
        QWidget.setTabOrder(self.pushButton_16, self.tableView_4)
        QWidget.setTabOrder(self.tableView_4, self.pushButton_17)
        QWidget.setTabOrder(self.pushButton_17, self.pushButton_5)
        QWidget.setTabOrder(self.pushButton_5, self.pushButton_7)
        QWidget.setTabOrder(self.pushButton_7, self.pushButton_18)
        QWidget.setTabOrder(self.pushButton_18, self.tableView_3)
        QWidget.setTabOrder(self.tableView_3, self.pushButton_11)
